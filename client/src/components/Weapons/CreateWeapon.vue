<template>
    <div class="container-fluid py-5">
      <h1 class="text-center">Create Weapon</h1>
      <form v-on:submit.prevent="createWeapon" class="mx-auto" style="max-width: 700px;">
        <div class="mb-3">
  ...
  export default {
    ...
    methods: {
      ...
      async createWeapon() {
        this.weapon.pictures = JSON.stringify(this.pictures);
        console.log("JSON.stringify: ", this.weapon);
        try {
          await WeaponsService.post(this.weapon);
          this.$router.push({
            name: "weapons",
          });
        } catch (err) {
